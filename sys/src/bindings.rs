...
pub const PRJ_NOTIFY_TYPES_PRJ_NOTIFY_USE_EXISTING_MASK: PRJ_NOTIFY_TYPES = -1;
pub type PRJ_NOTIFY_TYPES = i32;
...
pub struct PRJ_CALLBACKS {
    ...
    >,
    pub EndDirectoryEnumerationCallback: ::std::option::Option<
        unsafe extern "C" fn(arg1: *const PRJ_CALLBACK_DATA, arg2: *const GUID) -> HRESULT,
    >,
    pub GetDirectoryEnumerationCallback: ::std::option::Option<
        unsafe extern "C" fn(
    ...
    >,
    pub GetPlaceholderInfoCallback:
        ::std::option::Option<unsafe extern "C" fn(arg1: *const PRJ_CALLBACK_DATA) -> HRESULT>,
    pub GetFileDataCallback: ::std::option::Option<
        unsafe extern "C" fn(arg1: *const PRJ_CALLBACK_DATA, arg2: UINT64, arg3: UINT32) -> HRESULT,
    >,
    pub QueryFileNameCallback:
        ::std::option::Option<unsafe extern "C" fn(arg1: *const PRJ_CALLBACK_DATA) -> HRESULT>,
    pub NotificationCallback: ::std::option::Option<
        unsafe extern "C" fn(
            arg1: *const PRJ_CALLBACK_DATA,
            arg2: BOOLEAN,
    ...
    >,
    pub CancelCommandCallback:
        ::std::option::Option<unsafe extern "C" fn(arg1: *const PRJ_CALLBACK_DATA)>,
}
#[test]
